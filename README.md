...
<div>
  <p align="left">
    В будущем будет новостной сайт, пока заложена только основа (Проект чисто учебный).
    Структура приложения строилась на Feature-sliced docs: https://feature-sliced.design/docs
  </p>
</div>
<div> 
<h3>Возможности:</h3>
...
<p align="left">
  <ol>
    <li>Пользователь может менять тему на черную или белую</li>
    <li>Пользователь может менять язык интерефейса (Ru, En)</li>
    <li>Дополнится в скором времени...</li>
  </ol>
</p>
